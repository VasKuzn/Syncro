        ...
        <div className="reset-password-page-background">
            <div className="reset-password-container">
                <div className="reset-password-header">
                    ...
                    <p className="reset-password-subtitle">Создайте новый пароль для вашего аккаунта</p>
                </div>
                ...
                {successMessage ? (
                    ...
                    <form id="reset-password-form" onSubmit={onSubmit} noValidate>
                        <div className="reset-password-inputs">
                            {/* Новый пароль */}
                            <label htmlFor="newPassword" className="reset-password-label">Новый пароль</label>
                            ...
                            <label htmlFor="confirmPassword" className="reset-password-label">Подтверждение пароля</label>
                            <div className="reset-password-field-wrapper">
                                <input
                                    className="reset-password-input"
